...
- `OPENCLAW_INSTALL_BREW_CLI` — build arg (`1`) installs Homebrew (Linuxbrew), openai-whisper (incl. ffmpeg), ClawHub CLI, and himalaya in the image. Use for skills that require these CLIs.
